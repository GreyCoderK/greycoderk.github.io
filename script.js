...
const translations = {
  en: {
    ...
    exp3Title: 'API Developer <span class="accent">@ KeyOpsTech</span>',
    exp3Desc: 'Designed and developed REST APIs powering the platform\'s core services.',
    exp4Title: 'Backend & Mobile Developer <span class="accent">@ Adjemin</span>',
    exp4Desc: 'Shipped mobile apps with Flutter and built fullstack web services with Laravel.',
    exp5Title: 'Lead Data Analyst <span class="accent">@ NaN - Not a Number</span>',
    exp5Desc: 'Led data analysis projects using Python, R, and machine learning models for classification and prediction.',
    // Featured
  ...
  fr: {
    ...
    exp3Title: 'Développeur API <span class="accent">@ KeyOpsTech</span>',
    exp3Desc: 'Conception et développement d\'APIs REST alimentant les services principaux de la plateforme.',
    exp4Title: 'Développeur Backend & Mobile <span class="accent">@ Adjemin</span>',
    exp4Desc: 'Applications mobiles avec Flutter et services web fullstack avec Laravel.',
    exp5Title: 'Lead Data Analyst <span class="accent">@ NaN - Not a Number</span>',
    exp5Desc: 'Direction de projets d\'analyse de données avec Python, R et modèles de machine learning.',
